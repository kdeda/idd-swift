    ...
    private final class Helper: @unchecked Sendable {
        ...
        func forceTerminate(in timeOutInMilliseconds: Int) async {
            ...
            guard !Task.isCancelled,
                ...
                Log4swift["IDDSwift.Process"].info("'\(taskDescription)' is not running any longer")
                return
            }
            Log4swift["IDDSwift.Process"].info("'\(taskDescription)' will be terminated immediately")
            process.terminate()
